...
**墨鱼**（inco）是基于 InkSight 构建的智能墨水屏桌面伴侣。通过后端 LLM（DeepSeek / 通义千问 / Kimi）生成基于当前环境（天气、时间、日期、节气）的个性化内容，在 4.2 英寸电子墨水屏上展示。支持 19 种内容模式，从哲学语录到健身计划，从科技简报到每日食谱，从老黄历到人生进度条，为你的桌面带来有温度的智能陪伴。模式系统支持 JSON 配置驱动扩展——无需编写 Python 即可创建自定义内容模式。

**核心特点：**

- **19 种内容模式** — 斯多葛哲学、毒舌吐槽、禅意、每日推荐、AI 简报、AI 画廊、食谱、健身、诗词、倒计时、老黄历、慢信、历史上的今天、每日一谜、每日一问、认知偏差、微故事、人生进度条、微挑战 + 自定义 JSON 模式
...
- [x] 19 种内容模式（老黄历、慢信、历史上的今天、每日一谜、每日一问、认知偏差、微故事、人生进度条、微挑战 + 原有 10 种）
- [x] 多 LLM 提供商支持
